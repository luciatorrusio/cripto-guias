...
<ol type="a">
  ...
  <li>¿Cuál es el mayor tamaño que puede tener el espacio de textos planosM como para que elcifrado de sustitución monoalfabética posea secreto perfecto?</li>
...
$Pr[C=c_i] =\sum^{26}_{j=1} Pr[M=m_j] * Pr[K = K_j]$